...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
            ...
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <img id="imgs" src="/static/default.png" style="width:150px;height:120px;">
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary add_banner" type="button"  data-url="<?php echo url('/v1/ban/banner/add'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>

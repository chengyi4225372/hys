...
<style>
    ...
    .dialog-footer{position:fixed;right:35%;top:95%;}
    .red-color{color:red;}
</style>
    ...
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    <label for="keywords" class="col-sm-3 control-label">新闻seo关键字：</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="keywords"  value="<?php echo $info['keywords']; ?>" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="file" onchange="customerImgs()" style="display:none;" class="form-control form-control-sm" id="file" />
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary edit_cust" type="button"  data-url="<?php echo url('/v1/cust/customer/edit'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>

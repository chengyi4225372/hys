...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                <div class="form-group">
                    <label for="title" class="col-sm-3 control-label">关键字标题</label>
                    <div class="col-sm-9">
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary add_keys" type="button"  data-url="<?php echo url('/v1/keys/keywords/add'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>

...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9" >
                        <select id="keywords" class="selectpicker" multiple  title="请选择..." >
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary add_taxa" type="button"  data-url="<?php echo url('/v1/taxa/taxation/add'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>

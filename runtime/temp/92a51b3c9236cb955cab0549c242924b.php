...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="file" onchange="uploadImgs()" style="display:none;" class="form-control form-control-sm" id="file" />
                        <img id="imgs" src="<?php echo (isset($info['imgs']) && ($info['imgs'] !== '')?$info['imgs']:'/static/default.png'); ?>" style="width:150px;height:120px;">
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary edit_banner" type="button"  data-url="<?php echo url('/v1/ban/banner/edit'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>

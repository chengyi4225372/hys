<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"/opt/web/hys/public/../application/home/view/programme/productservice.html";i:1581412258;s:53:"/opt/web/hys/application/home/view/common/header.html";i:1580963987;s:53:"/opt/web/hys/application/home/view/common/footer.html";i:1580963986;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  $(document).ready(function () {
        ...
        <div class="content">
            <div class="series">
                <div style="position: relative;">
                    ...
                    <button class="btn1" onclick="alert_open('惠优税产品服务','入驻型税筹产品')"></button>

                </div>
                <img class="lazyload" data-src="/static/home/images/series2.png" alt="">
                <img class="lazyload" data-src="/static/home/images/service.png" alt="">
                <img class="lazyload" data-src="/static/home/images/case.png" alt="">
                <img class="lazyload" data-src="/static/home/images/step.png" alt="">
                <img class="lazyload" data-src="/static/home/images/advantage2.png" alt="">
                <img class="lazyload" data-src="/static/home/images/afterSales.png" alt="">
                <button class="btn2" onclick="alert_open('惠优税产品服务','个人代报税产品')"></button>
                <input type="button"  class="btn3" onclick="alert_open('惠优税产品服务','售后服务')" />
            </div>
        </div>
    ...
    <div class="bottomBox">
      ...
      <div class="consultation">
        <div>
          <div class="consultation-title" onclick="alert_open('惠优税产品服务','右导航')">咨询方案</div>
        </div>
        <div>

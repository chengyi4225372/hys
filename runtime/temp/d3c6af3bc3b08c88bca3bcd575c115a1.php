...
<style>
    ...
    .dialog-footer{position:fixed;right:45%;top:93%}
    .red-color{color:red;}
    /* 修改原有下拉框*/
...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="title"  value="<?php echo $info['title']; ?>" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control form-control-sm" id="sort" value="<?php echo $info['sort']; ?>"  />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9" >
                        <select id="keywords" class="selectpicker" multiple  title="<?php echo $info['keywords']; ?>" >
                            ...
                            <option value="<?php echo $ko['title']; ?>" data-width="100%" <?php if(in_array($ko['title'],$keywords)): ?> selected="selected" <?php endif; ?> ><?php echo $ko['title']; ?></option>
                ...
                <div class="form-group">
                    <label for="username" class="col-sm-3 control-label">
                        <span class="red-color">*</span>新闻展示图：
                    </label>

                    <div class="col-sm-9">
                        <input type="file" onchange="uploads()" style="display:none;" class="form-control form-control-sm" id="file" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm"   id="skeyword" value="<?php echo (isset($info['skeyword']) && ($info['skeyword'] !== '')?$info['skeyword']:''); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea  id="description" class="form-control form-control-sm"  rows="5"><?php echo $info['description']; ?></textarea>
                    </div>
                </div>
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary edit_taxa" type="button"  data-url="<?php echo url('/v1/taxa/taxation/edit'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>

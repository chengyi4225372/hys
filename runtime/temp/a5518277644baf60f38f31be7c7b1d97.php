<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"C:\phpEnv\www\hys\public/../application/home\view\customer\info.html";i:1575365664;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container">
        ...
        <div class='main_content'>
            <div class='content_middle'>
                <div class='bread_title'><a onclick="go_work(this)" data-url="<?php echo url('/home/index/index'); ?>">惠优税</a> > <a
                        onclick="go_news(this)" data-url="<?php echo url('/home/industry/index'); ?>">资讯</a> > 新闻详情</div>
                <div class='pic_total'>
                    ...
                    <div class='tuwen'>
                        <div class='wenzi'>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda debitis ex laboriosam
                            laborum maiores possimus quas, veniam voluptatibus! Delectus facere maxime nisi quam,
                            quibusdam quos repudiandae sed voluptate. Illo, iusto?
                        </div>

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:105:"C:\Users\Administrator\Desktop\phpEnv5.6.0-Green\www\hys\public/../application/home\view\index\index.html";i:1575247207;}*/ ?>
<!DOCTYPE>
<html lang="en">
...
<div class='container'>
    <div type="hidden" data="<?php if(empty($userinfo['userType'])): ?>emptys<?php else: ?><?php echo $userinfo['userType']; endif; ?>" id="user_type"></div>
    <!-- 导航部分 -->
    <div class="nav-box">
    ...
    <div class='header-box' style="background: url(<?php echo $chart['imgs']; ?>) no-repeat center bottom;">
        <div class='w header-container clearfix'>
            ...
            <div class="header-search">
                ...
                <div onclick="keyword_search(this)" login_url="<?php echo config('curl.ge_login_url'); ?>" loca_url="<?php echo config('curl.hou_tai_url'); ?>/personTask/myTask">搜索</div>
            </div>

...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control form-control-sm" id="sort" placeholder="请输入数字，越大排序靠前" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="keywords"  value="" />
                    </div>
                </div>
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary add_cust" type="button"  data-url="<?php echo url('/v1/cust/customer/add'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>
